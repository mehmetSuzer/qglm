...
typedef int16_t q12_4_t;

#define Q_TYPE int16_t
#define Q_WIDE int32_t

#define Q_INT_BITS  12
#define Q_FRAC_BITS  4

#define Q_INT_MASK  ((uint16_t)0xFFF0u)
#define Q_FRAC_MASK ((uint16_t)0x000Fu)

#define Q_MIN            ((Q_TYPE)INT16_MIN)               // -2048.0
#define Q_MAX            ((Q_TYPE)INT16_MAX)               // +2048.0 - 2^(-4)
...
#define Q_PI             ((Q_TYPE)50)                      // pi
#define Q_TWOPI          ((Q_TYPE)101)                     // pi * 2.0
#define Q_HALFPI         ((Q_TYPE)25)                      // pi / 2.0
#define Q_THIRDPI        ((Q_TYPE)17)                      // pi / 3.0
#define Q_QUARTERPI      ((Q_TYPE)13)                      // pi / 4.0
#define Q_1_PI           ((Q_TYPE)5)                       // 1.0 / pi
#define Q_2_PI           ((Q_TYPE)10)                      // 2.0 / pi
#define Q_3_PI           ((Q_TYPE)15)                      // 3.0 / pi
#define Q_4_PI           ((Q_TYPE)20)                      // 4.0 / pi
#define Q_SQRTPI         ((Q_TYPE)28)                      // sqrt(pi)
#define Q_1_SQRTPI       ((Q_TYPE)9)                       // 1.0 / sqrt(pi)
#define Q_2_SQRTPI       ((Q_TYPE)18)                      // 2.0 / sqrt(pi)
#define Q_3_SQRTPI       ((Q_TYPE)27)                      // 3.0 / sqrt(pi)

#define Q_E              ((Q_TYPE)43)                      // e
#define Q_LOG2_E         ((Q_TYPE)23)                      // log2(e)
#define Q_LOG2_10        ((Q_TYPE)53)                      // log2(10)
#define Q_LN2            ((Q_TYPE)11)                      // ln(2.0)
#define Q_LN10           ((Q_TYPE)37)                      // ln(10.0)
#define Q_LOG10_2        ((Q_TYPE)5)                       // log10(2)
#define Q_LOG10_E        ((Q_TYPE)6)                       // log10(e)

#define Q_SQRT2          ((Q_TYPE)23)                      // sqrt(2.0)
#define Q_SQRT3          ((Q_TYPE)28)                      // sqrt(3.0)
#define Q_1_SQRT2        ((Q_TYPE)11)                      // 1.0 / sqrt(2.0)
#define Q_1_SQRT3        ((Q_TYPE)9)                       // 1.0 / sqrt(3.0)
#define Q_HALFSQRT3      ((Q_TYPE)14)                      // 0.5 * sqrt(3.0)
#define Q_1_2SQRT3       ((Q_TYPE)5)                       // 0.5 / sqrt(3.0)

#define Q_TO_RADIAN      ((Q_TYPE)0)                       // pi / 180.0 (Q_ZERO due to insufficient precision)
#define Q_TO_DEGREE      ((Q_TYPE)917)                     // 180.0 / pi
...
#define Q_VEC2 q12_4_vec2_t
#define Q_VEC3 q12_4_vec3_t
#define Q_VEC4 q12_4_vec4_t

#include "vector/q_vec2_template.h"
#include "vector/q_vec3_template.h"
#include "vector/q_vec4_template.h"

#define Q_QUAT q12_4_quat_t

#include "quat/q_quat_template.h"

#define Q_MAT2      q12_4_mat2_t
#define Q_MAT2X3    q12_4_mat2x3_t
#define Q_MAT2X4    q12_4_mat2x4_t
#define Q_MAT3X2    q12_4_mat3x2_t
#define Q_MAT3      q12_4_mat3_t
#define Q_MAT3X4    q12_4_mat3x4_t
#define Q_MAT4X2    q12_4_mat4x2_t
#define Q_MAT4X3    q12_4_mat4x3_t
#define Q_MAT4      q12_4_mat4_t
...
#define Q_RAY           q12_4_ray_t
#define Q_AABB          q12_4_aabb_t
#define Q_PLANE         q12_4_plane_t
#define Q_SPHERE        q12_4_sphere_t
#define Q_TRIANGLE      q12_4_triangle_t
#define Q_COLLISION     q12_4_collision_t
